...
- **Origin IPs (CF Bypass):** 2
- **WAF Detected:** None
- **Security Headers Missing:** 4
- **Org:** 
- **Wayback URLs:** 0
...
|---|----------|---------|-------|-----|
| 1 | MEDIUM | Cookie hardening: AWSALB | https://13.126.75.174/login/ | CWE-614 |
| 2 | MEDIUM | Missing Content-Security-Policy | https://13.126.75.174/login/ | CWE-693 |
| 3 | MEDIUM | Missing Content-Security-Policy | https://13.233.60.142/login/ | CWE-693 |
...
| 6 | LOW | No clickjacking protection | https://13.126.75.174/login/ | CWE-1021 |
| 7 | LOW | Missing Referrer-Policy | https://13.126.75.174/login/ | CWE-200 |
| 8 | LOW | Missing HSTS | https://13.126.75.174/login/ | CWE-319 |
| 9 | LOW | No clickjacking protection | https://13.233.60.142/login/ | CWE-1021 |
| 10 | LOW | Missing Referrer-Policy | https://13.233.60.142/login/ | CWE-200 |
| 11 | LOW | Missing HSTS | https://13.233.60.142/login/ | CWE-319 |
...
|---|---------|-----------------|--------|
| 1 | Cookie hardening: AWSALB | Set AWSALB with Secure; HttpOnly; SameSite=Lax (or Strict). | — |
...
| # | Finding | Evidence |
|---|---------|----------|
| 1 | Cookie hardening: AWSALB | `AWSALB=bub2G2/EYJDisorYi92Re6Ihpp8QKBsrOg9NvLr3Jth3cRlkZ0CQoaKWLtcfYAM1yoAPhQy5te9FhkvyY3OXQEPeATCW6` |
...
- **Authorized target(s):** dev.postud.io
...
| Record | Value |
|--------|-------|
| A | 13.126.75.174, 13.206.10.220, 13.203.115.171 |
| MX | 13.206.10.220, 13.126.75.174, 13.203.115.171 |
| NS | 13.126.75.174, 13.206.10.220, 13.203.115.171 |
...
|-----|--------|--------|------|-------|
| http://dev.postud.io:80/ | 200 |  | Has XCTO |  |
...
| https://dev.postud.io:443/ | 200 |  | Has XCTO |  |
...
| https://www.postud.io | 200 | nginx/1.29.8 | Calendly, Tawk.to, Tailwind CS | Postudio — AI-Powered Post-Production OS |
| https://www.postud.io/ | 200 | nginx/1.29.8 | Drift, Tawk.to, nginx | Postudio — AI-Powered Post-Production OS |

## Open Ports

| IP | Ports |
|----|-------|
| dev.postud.io | 443, 80 |
...
| Subdomain | IP |
|-----------|-----|
| dev.postud.io | 13.206.10.220 |
| api.dev.postud.io | 3.6.85.149 |
...
- **http://dev.postud.io:80/**: Has XCTO
- **https://dev.postud.io/**: Has XCTO
- **https://dev.postud.io:443/**: Has XCTO
- **https://www.postud.io**: Drift, Tawk.to, nginx
- **https://www.postud.io/**: Drift, Tawk.to, nginx

---
*Report generated by MrBOOM One-Shot | 2026-08-03 07:44 UTC*